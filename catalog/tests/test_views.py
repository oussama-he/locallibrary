...
class AuthorListViewTest(TestCase):
    ...
    def test_pagination_is_ten(self):
        ...
        self.assertTrue(len(response.context['author']) == 10)
...
class LoanedBookInstanceByUserListViewTest(TestCase):
    ...
    def test_logged_in_use_correct_template(self):
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        for bookitem in response.context['bookinstance_list']:
            self.assertEqual(response.cotext['user'] == bookitem.borrower)
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_logged_in_with_permission_another_user_borrowed_books(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse('renew-book-librarian', kwargs={'pk': self.test_bookinstance1.pk}))
        self.assertEqual(response.status_code, 200)
    ...
    def test_form_renewal_date_past(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
